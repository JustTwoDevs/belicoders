...
export default function CreateRival() {
  return (
    <main className="flex flex-col py-8 px-4 min-h-screen w-full">
      <section className="flex md:flex-col lg:flex-row gap-5 w-full h-[82vh]">
      ...
      <section className="flex gap-5 p-5 md:justify-end lg:justify-end w-full h-full">
        <Button
